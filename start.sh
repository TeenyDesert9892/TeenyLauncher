...
"u-venv/bin/python3" -m pip install --upgrade minecraft_launcher_lib
"u-venv/bin/python3" -m pip install --upgrade icecream
"u-venv/bin/python3" Main/TeenyLauncher.py